...
<sch:schema xmlns:sch="http://purl.oclc.org/dsdl/schematron" queryBinding="xslt2">
  ...
  <sch:pattern>
    <sch:title>f:Task/f:meta/f:tag</sch:title>
    <sch:rule context="f:Task/f:meta/f:tag">
      <sch:assert test="count(f:id) &lt;= 1">id: maximum cardinality of 'id' is 1</sch:assert>
  ...
  <sch:pattern>
    <sch:title>f:Task/f:for</sch:title>
  ...
  <sch:pattern>
    <sch:title>f:Task/f:requester</sch:title>
  ...
  <sch:pattern>
    <sch:title>f:Task/f:owner</sch:title>
  ...
  <sch:pattern>
    <sch:title>f:Task/f:reasonReference</sch:title>
